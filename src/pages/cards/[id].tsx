...
export default function Page() {
   return (
      <div className="flex flex-col w-5/6">
         <h1 className="text-2xl font-bold pb-3">Birthday Boy</h1>
         ...
         <Grid justify="space-between" className="pt-3 pb-2">
            <Grid.Col span={3} className="text-lg font-bold">
               Character
            </Grid.Col>
            <Grid.Col span={3} className="text-lg text-right">
               Malleus Draconia
            </Grid.Col>
         </Grid>
         <Divider></Divider>
         <Grid justify="space-between" className="pt-3 pb-2">
            <Grid.Col span={2} className="text-lg font-bold">
               Title
            </Grid.Col>
            <Grid.Col span={2} className="text-lg text-right">
               Birthday Boy
            </Grid.Col>
         </Grid>
         <Divider></Divider>
         ...
         <h1 className="text-xl font-bold pt-10 pb-2">Stat</h1>

         <h1 className="text-xl font-bold pt-10 pb-2">Buddy Bonus</h1>

         <h1 className="text-xl font-bold pt-10 pb-2">Quotes</h1>
      </div>
   );
}
